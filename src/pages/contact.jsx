...
import contactData from "@content/homepage/homepage.json"
...
const Contact = () => {
    ...
    <Layouts>
        ...
        <section className="gap contact-form-2">
            ...
            <div className="row">
                <div className="col-lg-7" >
                    <div className="data">
                        <span>{Data.contactForm.subtitle}</span>
                        <h2>{Data.contactForm.title}</h2>
                        <p>{Data.contactForm.text}</p>
                        <Formik
                ...
                <div className="bio">
                    <div className="data">
                        <figure>
                            <img className="author" src={appData.siteSettings.ownerImage.image} alt={appData.siteSettings.ownerImage.alt} />
                        </figure>
                        <h3>{appData.siteSettings.siteOwner}</h3>
                        <p>{appData.siteSettings.siteTitle}</p>
                        <figure>
                        <img className="light-icon" src={contactData.aboutSection1.signature.light} alt={contactData.aboutSection1.signature.alt} />
                        <img className="dark-icon" src={contactData.aboutSection1.signature.dark} alt={contactData.aboutSection1.signature.alt} />
                        </figure>
                    </div>
                </div>
                <div className="info">
                    <ul className="contact">
                        <li>
                            ...
                            <div>
                                <h3>Address:</h3>
                                <p>{appData.footerInfo.info.address}</p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div>
                                <h3>Telephone:</h3>
                                <p>{appData.footerInfo.info.tel}</p>
                        ...
                        <li>
                            ...
                            <div>
                                <h3>Email:</h3>
                                <p>{appData.footerInfo.info.email}</p>
        ...
        <iframe src={Data.contactMap.url} width="600" height="760" style={{border: 0}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        </div>
        {/* Contact Map End */}
