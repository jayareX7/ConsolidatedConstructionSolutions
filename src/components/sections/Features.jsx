...
const FeaturesSection = () => {
  ...
  return (
    <section className="core-features">
        ...
        <div className="row">
            ...
            <div className="space">
                ...
                <div className="container">
                    ...
                    <div className="col-lg-12">
                        <div className="data">
                            <span>{Data.features.subtitle}</span>
                ...
                <Accordion defaultActiveKey="features-acc-0">
                    {Data.features.items.map((item, key) => (
            ...
            <div className="col-lg-6" >
                <div className="shape">
                    <div className="video">
                        <figure>
                            <img src={Data.features.image.url} alt={Data.features.image.alt} />
                        </figure>
        ...
        <ModalVideo channel='youtube' isOpen={isOpen} videoId={Data.features.yt_video_id} onClose={() => setOpen(false)} />
    </section>
  );
};
