  ...
  return (
    <footer className="footer-style-one">
                ...
                <div className="footer-col">
                    ...
                    <ul>
                        <li>
                            ...
                            <p>{appData.companyInfo.info.address}</p>
                        </li>
                        <li>
                            ...
                            <p>{appData.companyInfo.info.tel}</p>
                        </li>
                        <li>
                            ...
                            <p>{appData.companyInfo.info.email}</p>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div className="container">
            <div className="row">
            <div className="footer-col">
                <p dangerouslySetInnerHTML={{ __html: appData.companyInfo.copy }} />
