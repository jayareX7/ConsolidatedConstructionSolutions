  ...
  return (
    <footer className="footer-style-one">
        ...
        <div className="container">
            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
                <div className="footer-col">
                    <h3>{appData.footerInfo.information.title}</h3>
                    <p>{appData.footerInfo.information.text}</p>
                </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12">
                <div className="footer-col">
                    <h3>{appData.footerInfo.info.title}</h3>
                    <ul>
                        <li>
            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
                <div className="footer-col">
                    <h3>{appData.footerInfo.newsletter.title}</h3>
                    <p>{appData.footerInfo.newsletter.text}</p>
                    <form action={appData.mailchimp.url} method="post" target="_blank">
                        <input type="email" name="EMAIL" placeholder="Enter your email." required />
                        <input type="hidden" name={appData.mailchimp.key} />
                        <button type="submit">
        ...
        <div className="container">
            <div className="row">
            <div className="footer-col">
                <p dangerouslySetInnerHTML={{ __html: appData.footerInfo.copy }} />
